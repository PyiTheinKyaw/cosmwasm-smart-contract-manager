...
const ConfirmNetworkModal: React.FC<CNModal> = ({shouldOpen}) => {
    ...
    return(
      <>      
        <Modal
            title="Network Configuration Setting"
